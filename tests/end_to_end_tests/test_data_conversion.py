...
from haplo.internal.data_conversion import constantinos_kalapotharakos_format_file_to_xarray_zarr, DatasetVariableName


def test_constantinos_kalapotharakos_format_file_to_xarray_zarr():
    input_path = Path(__file__).parent.joinpath('test_data_conversion_resources/mcmc_vac_all_100.dat')
    output_path = Path(__file__).parent.joinpath('test_data_conversion_resources/100_svf_dataset.zarr')
