...
def infer_from_parameters_to_phase_amplitudes(input_csv_path: Path, output_csv_path: Path) -> None:
    ...
    for normalized_parameters_chunk in split_array_into_chunks(normalized_parameters, chunk_size=100):
    ...
    phase_amplitudes = NicerExample.unnormalize_parameters(normalized_phase_amplitudes)
