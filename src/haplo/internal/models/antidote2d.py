...
from torch.nn import Module, ModuleList, Conv2d, LeakyReLU, Identity, GELU, BatchNorm1d, ConvTranspose1d, Upsample, \
    ConstantPad1d, Dropout1d, ReLU

from haplo.internal.models.residual_generation_light_curve_network_block2d import ResidualGenerationLightCurveNetworkBlock
        ...
        for output_channels in [512, 512, 256, 128, 64, 32]:
            ...
            for _ in range(2):
                self.blocks.append(ResidualGenerationLightCurveNetworkBlock(input_channels=input_channels,
                                                                            ...
                                                                            activation_type=LeakyReLU))
                input_channels = output_channels
        self.end_conv0 = Conv2d(input_channels, 20, kernel_size=1)
        self.end_conv1 = Conv2d(self.end_conv0.out_channels, 10, kernel_size=1)
        self.end_conv2 = Conv2d(self.end_conv1.out_channels, 1, kernel_size=1)
